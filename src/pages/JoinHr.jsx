...
const JoinHR = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_URL}/users`, hrData, { timeout: 10000 });
      clearPendingProfile();
      await logOut();
    ...
    <div className="min-h-screen flex items-center justify-center bg-base-200 py-12 px-4">
      ...
      <div className="w-full max-w-md bg-base-100 rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-base-content/70">Join AssetVerse as HR Manager</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              className="file-input file-input-bordered w-full rounded-lg border-2 border-base-300 bg-base-200"
            />
            {companyLogoFile && (
              <p className="text-xs text-base-content/60 mt-1">
                Selected logo: {companyLogoFile.name}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {profileAvatarFile && (
              <p className="text-xs text-base-content/60 mt-1">
                Selected avatar: {profileAvatarFile.name}
              </p>
            )}
          </div>
